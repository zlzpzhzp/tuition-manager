                          ...
                          {editingClassId === cls.id ? (
                            ...
                            <>
                              ...
                              {getTeacherName(cls.teacher_id) && (
                                <span className="text-[10px] sm:text-xs text-gray-500 shrink-0 hidden sm:inline">{getTeacherName(cls.teacher_id)}</span>
                              )}
                              {cls.class_days && (
                    ...
                    <div key={teacher.id} className="flex items-center gap-2 bg-gray-50 rounded-lg px-3 py-2">
                      {editingTeacherId === teacher.id ? (
                        ...
                        <>
                          ...
                          <button onClick={() => deleteTeacher(teacher.id, teacher.name)} className="p-1 text-gray-400 hover:text-red-500" aria-label="삭제">
