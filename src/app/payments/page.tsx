      ...
      {[...Array(2)].map((_, gi) => (
        <div key={gi} className="mb-4">
          ...
          <div className="bg-white rounded-xl border border-gray-100 overflow-hidden">
            <div className="px-4 py-2 bg-gray-50 border-b border-gray-100"><div className="h-3 bg-gray-200 rounded w-24"></div></div>
            {[...Array(4)].map((_, si) => (
            ...
            <div className="bg-white rounded-xl border border-gray-100 overflow-hidden">
              {grade.classes.map(cls => {
                ...
                return (
                  <div key={cls.id}>
                    <div
                      className="px-4 py-2 bg-gray-50 border-b border-gray-100 flex items-center cursor-pointer active:bg-gray-100 select-none"
