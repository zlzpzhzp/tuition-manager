...
export async function GET(request: Request) {
  ...
  let query = supabase.from('tuition_payments').select('id, student_id, amount, method, payment_date, billing_month, cash_receipt, receipt_images, memo, created_at').order('payment_date', { ascending: false })
